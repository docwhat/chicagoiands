...
describe 'The layout has menu tabs' do
  it 'has tabs on the homepage' do
    ...
    visit root_path
    expect(page).to have_selector('nav li#home.selected')
  end
  ...
  it 'has meetings selected on a meetings page' do
    ...
    # save_and_open_page
    expect(page).to have_selector('nav li#meetings.selected')
  end
  ...
  it 'has meetings selected on a stories page' do
    ...
    # save_and_open_page
    expect(page).to have_selector('nav li#stories.selected')
  end
end
